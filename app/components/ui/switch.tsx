...
const switchThumbVariants = cva(
  'pointer-events-none block w-1/2 h-[calc(100%-4px)] shadow-lg ring-0 transition-all start-0 data-[state=unchecked]:translate-x-[2px] data-[state=unchecked]:bg-black data-[state=checked]:translate-x-[calc(100%-2px)] data-[state=checked]:bg-white rtl:data-[state=unchecked]:-translate-x-[2px] rtl:data-[state=checked]:-translate-x-[calc(100%-2px)]',
  {
    variants: {
      shape: {
        pill: 'rounded-full',
